...
import { FaShapes, FaGlobe, FaPaintBrush } from "react-icons/fa";
...
const mainItems: SidebarItem[] = [
  { label: "Explorador de Formas", route: "/shapes", icon: <FaShapes /> },
  { label: "Globo Interactivo", route: "/globe", icon: <FaGlobe /> },
  { label: "Pintura 3D", route: "/paint", icon: <FaPaintBrush /> },
